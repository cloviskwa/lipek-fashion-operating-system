...
| [ADR-0014](../adr/ADR-0014-service-workflow-stage-vocabularies.md)                                        | **Proposed 2026-09-07** — stage vocabularies transcribed from SOT §10.2/§12.2/§13.2; six open questions (skips, loops, laundry table ownership, transition permissions, customer notifications, `READY_FOR_HANDOVER` naming) need sign-off | Blocks rebuild tasks `R-06`, `R-08`, `R-09` |
